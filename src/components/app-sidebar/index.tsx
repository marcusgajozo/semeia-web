...
import { Home, Users, Heart, Calendar, Music, Menu, ChevronLeft } from "lucide-react"
    ...
    <>
      ...
      >
          ...
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-sidebar-foreground">Church CMS</span>
        ...
        <div className="p-4 border-t border-sidebar-border">
          {!isCollapsed && <div className="text-xs text-muted-foreground text-center">v1.0.0</div>}
        </div>
      </aside>
